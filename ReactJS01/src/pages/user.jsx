...
const FriendPage = () => {
  ...
  const fetchRelationships = async () => {
    ...
    if (res?.EC === 0) {
      ...
      message.error(
        res?.EM || res?.message || "Không thể tải danh sách bạn bè",
      );
    }
  };
  ...
  const handleBlock = (userId) => {
    Modal.confirm({
      ...
      content:
        "Sau khi chặn, hai bên sẽ không còn thấy bài viết và không thể tương tác với nhau.",
      okText: "Chặn",
  ...
  const renderUser = (item, actions = []) => (
    ...
    >
      <List.Item.Meta
        avatar={
          <Avatar size={46} src={item?.avatar} icon={<UserOutlined />}>
            {item?.name?.[0]}
          </Avatar>
        }
    ...
    },
    {
      ...
      children: (
        <List
          ...
          locale={{
            emptyText: <Empty description="Không có lời mời kết bạn mới" />,
          }}
          renderItem={(request) =>
    ...
    },
    {
      ...
      children: (
        <List
          ...
          locale={{
            emptyText: <Empty description="Bạn chưa gửi lời mời nào" />,
          }}
          renderItem={(request) =>
            renderUser(request.user, [
        ...
        <div className="friends-header">
          <div>
            ...
            <Typography.Paragraph>
              Quản lý bạn bè, lời mời kết bạn, người đang theo dõi và các gợi ý
              kết nối.
            </Typography.Paragraph>
          </div>
